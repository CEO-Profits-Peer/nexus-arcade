/* ============================================================
   NEXUS ARCADE — nexus-i18n.js
   Übersetzungen für das Konto-/Level-/Shop-Fenster (account.js).
   Wird VOR account.js geladen und stellt window.NEXUS_I18N bereit.
   ============================================================ */
window.NEXUS_I18N = {
  en:{account:"Account",guest:"Guest",level:"Level",profile:"Profile",achievements:"Achievements",
    login:"Sign in",logout:"Sign out",email:"Your email",sendlink:"Send magic link",
    sent:"Check your inbox for the login link!",name:"Display name",avatar:"Avatar",frame:"Profile frame",
    save:"Save",saved:"Saved!",cloudon:"Synced to cloud",cloudoff:"Playing as guest (this device only)",
    signedin:"Signed in as",locked:"Locked",unlockAt:"Reaches at Level",xp:"XP",levelup:"Level up! You reached Level",
    unlocked:"Achievement unlocked:",notcfg:"Cloud sync is not configured yet.",syncing:"Syncing…",
  ...
  de:{account:"Konto",guest:"Gast",level:"Level",profile:"Profil",achievements:"Erfolge",
    ...
    save:"Speichern",saved:"Gespeichert!",cloudon:"Mit Cloud synchronisiert",cloudoff:"Als Gast (nur dieses Gerät)",
    signedin:"Angemeldet als",locked:"Gesperrt",unlockAt:"Ab Level",xp:"XP",levelup:"Level-Up! Du bist jetzt Level",
    unlocked:"Erfolg freigeschaltet:",notcfg:"Cloud-Sync ist noch nicht konfiguriert.",syncing:"Synchronisiere…",
