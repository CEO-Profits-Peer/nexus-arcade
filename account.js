...
(function(){
  ...
  /* ===== unten ausgelagert nach nexus-data.js (nicht mehr aktiv) =====
  const FRAMES = [
  ...
  // Titel (ausgelagert -> nexus-data.js)
  const TITLES = [
  ...
  // Achievements-Register (ausgelagert -> nexus-data.js)
  const ACH = [
    // --- Arcade / Meta ---
  ...
  // Auto-Bedingungen (ausgelagert -> nexus-data.js)
  ...
  */
  ...
  /* ---------- Tägliche Quests ---------- */
  /* ===== QUESTS ausgelagert nach nexus-data.js =====
  const QUESTS = [
    ...
    {id:"xp150", xp:80,  target:150, name:{en:"Grinder",de:"XP-Jäger"},           prog:(s,sn,v)=>Math.max(0,profile.xp-sn.xp)},
